...
class VideosHelper:
    ...
    def get_video_cover(self, _id):
        for ext in self.cover_supported_exts:
            if os.path.exists(os.path.join(os.path.dirname(__file__), "covers\\videos\\{}.{}".format(_id, ext))):
                return(os.path.join(os.path.dirname(__file__), "covers\\videos\\{}.{}".format(_id, ext)))
        return None

    def get_video_asset(self, _id):
        for ext in self.asset_supported_exts:
            if os.path.exists(os.path.join(os.path.dirname(__file__), "assets\\videos\\{}.{}".format(_id, ext))):
                return(os.path.join(os.path.dirname(__file__), "assets\\videos\\{}.{}".format(_id, ext)))
        return None
